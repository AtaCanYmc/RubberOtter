...
export const GamingPanel: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col space-y-4">
      ...
      <div className="instrument-card rounded-xl p-5 space-y-3.5">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="w-9 h-9 rounded-lg bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-500 dark:text-amber-400">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="0x41"
                  className="w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 text-xs font-mono text-zinc-900 dark:text-zinc-200 focus:outline-none focus:border-otter-500"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-900 dark:text-zinc-200 focus:outline-none focus:border-otter-500"
                />
              </div>
            </div>
          </div>
      ...
      <div className="space-y-2.5">
        ...
        <div className="grid grid-cols-1 gap-2.5">
          {macros.map((m) => (
            <div key={m.id} className="instrument-card rounded-xl p-3.5 flex items-center justify-between">
              <div>
                <h4 className="text-xs font-semibold text-zinc-900 dark:text-zinc-200">{m.name}</h4>
              ...
              <div className="flex items-center space-x-2">
                ...
                {m.category === 'User Custom' && (
                  <button
                    ...
                    className="btn-tactile p-1.5 rounded-lg bg-zinc-100 hover:bg-rose-50 text-zinc-500 hover:text-rose-600 dark:bg-zinc-900 dark:hover:bg-rose-950/40 dark:text-zinc-500 dark:hover:text-rose-400 border border-zinc-200 dark:border-zinc-800 transition-colors"
                  >
