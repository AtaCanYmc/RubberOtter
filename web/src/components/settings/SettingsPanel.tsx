    ...
    <div className="flex-1 flex flex-col space-y-4">
      ...
      <div className="instrument-card rounded-xl p-4 sm:p-5 space-y-3">
        <div className="flex items-center space-x-2 pb-2 border-b border-zinc-200 dark:border-zinc-800">
          <Moon className="w-4 h-4 text-otter-500 dark:text-otter-400" />
        ...
        <div className="grid grid-cols-3 gap-2.5 pt-1">
          ...
          >
            <Moon className="w-4 h-4 mx-auto mb-1 text-otter-400" />
            <h4 className="text-xs font-semibold">Dark</h4>
            <p className="text-[10px] text-zinc-500 font-mono mt-0.5">Obsidian Dark</p>
          </button>
          ...
          <button
            ...
            className={`btn-tactile p-3 rounded-lg border text-center transition-all ${
              settings.themeMode === 'light'
                ? 'bg-zinc-100 border-otter-500 text-zinc-900 font-semibold shadow-sm'
                : 'bg-zinc-100/60 dark:bg-zinc-900/60 border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200'
            }`}
          >
            <Sun className="w-4 h-4 mx-auto mb-1 text-amber-500" />
            <h4 className="text-xs font-semibold">Light</h4>
            <p className="text-[10px] text-zinc-500 font-mono mt-0.5">Clean White</p>
          </button>
          ...
          <button
            ...
            className={`btn-tactile p-3 rounded-lg border text-center transition-all ${
              settings.themeMode === 'system'
                ? 'bg-zinc-850 dark:bg-zinc-850 border-otter-500/60 text-zinc-100 font-semibold shadow-sm'
                : 'bg-zinc-100/60 dark:bg-zinc-900/60 border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200'
            }`}
          >
            <Monitor className="w-4 h-4 mx-auto mb-1 text-zinc-400" />
            <h4 className="text-xs font-semibold">System</h4>
            <p className="text-[10px] text-zinc-500 font-mono mt-0.5">OS Sync</p>
          </button>
        </div>
      </div>
      ...
      <div className="instrument-card rounded-xl p-4 sm:p-5 space-y-3">
        <div className="flex items-center space-x-2 pb-2 border-b border-zinc-200 dark:border-zinc-800">
          <Laptop className="w-4 h-4 text-otter-500 dark:text-otter-400" />
          ...
          <button
            ...
            className={`btn-tactile p-3 rounded-lg border text-center transition-all ${
              settings.targetOs === 'macos'
                ? 'bg-zinc-100 dark:bg-zinc-850 border-otter-500/60 text-zinc-900 dark:text-zinc-100 font-semibold shadow-sm'
                : 'bg-zinc-100/60 dark:bg-zinc-900/60 border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200'
            }`}
          >
      ...
      <div className="instrument-card rounded-xl p-4 sm:p-5 space-y-3">
        <div className="flex items-center space-x-2 pb-2 border-b border-zinc-200 dark:border-zinc-800">
          <Network className="w-4 h-4 text-otter-500 dark:text-otter-400" />
      ...
      <div className="instrument-card rounded-xl p-4 sm:p-5 space-y-3.5">
        <div className="flex items-center space-x-2 pb-2 border-b border-zinc-200 dark:border-zinc-800">
          <Shield className="w-4 h-4 text-otter-500 dark:text-otter-400" />
